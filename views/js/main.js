...
window.performance.mark("mark_start_generating"); // collect timing data
 ...
 function NewPizza() {
  ...
  //instead appending all the pizzas, here appends only once
  var pizzasDiv = document.getElementById("randomPizzas");
  var TotalPizzas = document.createDocumentFragment();

    // This for-loop actually creates and appends all of the pizzas when the page loads
  for (var i = 2; i < 100; i++) {
    TotalPizzas.appendChild(pizzaElementGenerator(i));
  }
    pizzasDiv.appendChild(TotalPizzas);
  }
...
//moved scrollTop out from for loop with this new variable;
